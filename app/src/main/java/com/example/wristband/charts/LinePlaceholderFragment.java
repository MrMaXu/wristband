...
public class LinePlaceholderFragment extends Fragment {

    private LineChartView chart;        //线型图表
    private LineChartData data;         //表中数据
    private int numberOfLines = 1;      //表中线的条数
    private int maxNumberOfLines = 4;   //表中最大线条数
    private int numberOfPoints = 12;    //表中最大数据点数

    float[][] randomNumbersTab = new float[maxNumberOfLines][numberOfPoints];//随机生成的二维数组
    ...
    public LinePlaceholderFragment() {
    }
...
//        chart.setOnValueTouchListener(new StatisticsActivity.LinePlaceholderFragment.ValueTouchListener());
